...
// ReduceFunc is a function that performs the reduce part of the MapReduce job
type ReduceFunc func(interface{}, chan interface{})
...
func mapReduce(mapper MapperFunc, reducer ReduceFunc, input chan interface{}) interface{} {
